...
<body translate="no">
  <i title="Go to top" onclick="topFunction()" id="myBtn" class="fa fa-arrow-up" aria-hidden="true" style="display: block;"></i>
<div class="container main">
  <div class="sidebar">
    <div class="sidebar-container">
      ...
      <a class="category-link" href="/console" >
        <div class="genre">Admin Console</div>
      </a>
  ...
  <div class="content" >
    <center><h1><b>KIGA MOVIE (KIGAMOV)</b></h1></center>
    <div class="inner-container">
      ...
      <div class="item-container">
        ...
        <a class="item link movies m11" id="566525" onclick="movieInfo(566525)" href="/detail/<?= $item['id'] ?>"><img src="<?= base_url('img/'.$item['thumb']);  ?>" class="image"><div class="item-inner"><h2 class="item-title"><?= $item['title'] ?> </h2><span class="rating"><i class="fa fa-star" aria-hidden="true"></i> <?= $item['rate'] ?></span></div></a>
